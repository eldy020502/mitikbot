...
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        await e.edit("SAYANG")
        await e.edit("EL")
        await e.edit("I LOVE YOUUUU EL")
        await e.edit("MY BABY")
        await e.edit("💕💞💘💝")
        await e.edit("💘💕💞💝")
        await e.edit("SAYANG EL BANYAK BANYAK💞")


@register(outgoing=True, pattern='^.dino(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit("`WIII WIBUUUUU.....`")
    sleep(1)
    await typew.edit("`ADAAA WIBUUUUUUUU!!`")
    sleep(1)
    await typew.edit("`🏃                        🤓`")
    await typew.edit("`🏃                       🤓`")
    await typew.edit("`🏃                      🤓`")
    await typew.edit("`🏃                     🤓`")
    await typew.edit("`🏃 `LARII ADA WIBUUU` 🤓`")
    await typew.edit("`🏃                   🤓`")
    await typew.edit("`🏃                  🤓`")
    await typew.edit("`🏃                 🤓`")
    await typew.edit("`🏃                🤓`")
    ...
    await typew.edit("`🏃            🤓`")
    await typew.edit("`🏃           🤓`")
    await typew.edit("`🏃Masih ngejar anj!   🤓`")
    await typew.edit("`🏃           🤓`")
    await typew.edit("`🏃            🤓`")
    await typew.edit("`🏃             🤓`")
    await typew.edit("`🏃              🤓`")
    ...
    await typew.edit("`🏃     🤓`")
    await typew.edit("`🏃    🤓`")
    await typew.edit("`Dhlh wibu taik:)`")
    sleep(1)
    await typew.edit("`🧎 🤓`")
    sleep(2)
    await typew.edit("`-TAMAT,DAN DIA PUN JADI WIBU-`")
...
async def _(event):
    ...
    if input_str == "cinta":
        ...
        animation_chars = [
            ...
            f"`Cintaku Sekarang Sepenuhnya Terkirim Padamu, Dan sekarang kamu milik el sepenuhnya😘`"]
